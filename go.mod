module github.com/carsonfarmer/mica

go 1.26.3

replace github.com/carsonfarmer/go-acp-sdk => ../go-acp-sdk

require (
	charm.land/catwalk v0.42.0
	charm.land/fantasy v0.23.2
	github.com/carsonfarmer/go-acp-sdk v0.0.0-00010101000000-000000000000
)
